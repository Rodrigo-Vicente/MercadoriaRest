    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EntradaMercadorias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EntradaMercadorias_Mercadorias_MercadoriaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaidaMercadorias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SaidaMercadorias_Mercadorias_MercadoriaId",
                        column: x => x.MercadoriaId,
                        principalTable: "Mercadorias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EntradaMercadorias_MercadoriaId",
                table: "EntradaMercadorias",
                column: "MercadoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_SaidaMercadorias_MercadoriaId",
